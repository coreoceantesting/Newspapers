            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('expandeture.index') }}"> List Expense (खर्चाची यादी) </a></li>
                        <li class="breadcrumb-item active">Add Expense (खर्च जोडा)</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <form action="{{ route('expandeture.store') }}" method="post">
                    ...
                    <div class="card">
                        <div class="card-header border-bottom pb-2 bg-primary">
                            <h5 class="text-white item-center mb-2">Add Expense (खर्च जोडा)</h5>
                        </div>

                        <div class="card-body">
                            <div class="row g-3 pb-3">
                                <div class="col-md-6 col-lg-6 col-12">
                                    <label class="form-label" for="billingId">Select Bill (बिल निवडा) <span class="error">*</span></label>
                                    <select name="billing_id" id="billingId" required class="form-select">
                                        <option value="">Select Bill (बिल निवडा)</option>
                                ...
                                <div class="col-md-6 col-lg-6 col-12">
                                    ...
                                    <label class="form-label" for="news_paper_name">Newspaper Name (वर्तमानपत्र नाव) <span class="error">*</span></label>
                                ...
                                <div class="col-md-6 col-lg-6 col-12">
                                    <label class="form-label" for="invoice_amount">Invoice Amount (देयाकावारची रक्कम) <span class="error">*</span></label>
                                ...
                                <div class="col-md-6 col-lg-6 col-12">
                                    <label class="form-label" for="other_charges">Other Change (इतर शुल्क) <span class="error">*</span></label>
                                ...
                                <div class="col-md-6 col-lg-6 col-12">
                                    <label class="form-label" for="net_amount">Net Amount (निव्वळ रक्कम) <span class="error">*</span></label>
                                ...
                                <div class="col-md-6 col-lg-6 col-12">
                                    <label class="form-label" for="progressive_expandetures">Progressive Expandetures (प्रगतीशील खर्च) <span class="error">*</span></label>
                                ...
                                <div class="col-md-6 col-lg-6 col-12">
                                    <label class="form-label" for="balance">Balance Amount (पुढील खर्चासाठी शिल्लक) <span class="error">*</span></label>
                            ...
                            <div class="text-end" >
                                <button onClick="return confirm('A bill cannot be edited and deleted once an expandature is created')" class="btn btn-square btn-success-gradien" type="submit">Submit (जतन करा) </button>
                                <a href="{{ route('expandeture.index') }}"><button class="btn btn-square btn-dark" type="button">Cancel (रद्द करा) </button></a>
                            </div>
                        </div>
                    </div>
                </form>
