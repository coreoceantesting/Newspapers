                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="action">
                                                <li class="edit">
                                                    <a href="{{ route('publication-type.edit', $publicationType->id) }}"><button class="btn btn-square btn-primary" type="button"><i class="fa fa-pencil text-white" aria-hidden="true"></i>
                                                    </button></a>
                                                </li>
                                                <li class="delete">
