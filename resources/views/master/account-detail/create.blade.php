                        ...
                        <div class="card-body">
                            <div class="row g-3 pb-3">
                                ...
                                <div class="col-md-6 col-lg-6 col-12">
                                    ...
                                    <input @if ($errors->has('account_number')) class="form-control is-invalid" @else style="border: 1px solid #475ecc6b;"  @endif class="form-control"  name="account_number" required id="account_number" onkeypress="return event.charCode &gt;= 48 &amp;&amp; event.charCode &lt;= 57" maxlength="50" type="text" placeholder="खाते क्रमांक" value="{{ old('account_number') }}">
