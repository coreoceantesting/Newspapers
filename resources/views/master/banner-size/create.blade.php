            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add Banner Size (बॅनर आकार जोडा)</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <form action="{{ route('banner-size.store') }}" method="post">
                    ...
                    <div class="card">
                        <div class="card-header border-bottom pb-2 bg-primary">
                            <h5 class="text-white item-center mb-2">Add Banner Size (बॅनर आकार जोडा)</h5>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row g-3 pb-3">
                                <div class="col-md-6 col-lg-6 col-12">
                                    ...
                                    <input @if ($errors->has('size')) class="form-control is-invalid" @else style="border: 1px solid #475ecc6b;"  @endif class="form-control"  name="size" id="size" type="text" placeholder="बॅनर आकार" value="{{ old('size') }}">
                                    @error('size')
