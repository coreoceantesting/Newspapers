            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('banner-size.index') }}">बॅनर आकार यादी </a></li>
                        <li class="breadcrumb-item active">बॅनर आकार जोडा</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <form action="{{ route('banner-size.update', $bannerSize->id) }}" method="post">
                    ...
                    <div class="card">
                        <div class="card-header border-bottom pb-2 bg-primary">
                            <h5 class="text-white item-center mb-2">बॅनर आकार जोडा</h5>
                        </div>

                        <div class="card-body">
                            <div class="row g-3 pb-3">
                                <div class="col-md-6 col-lg-6 col-12">
                                    <label class="form-label" for="size">बॅनर आकार <span class="error">*</span></label>
