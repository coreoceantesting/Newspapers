            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Edit Budget Provision (बजेट तरतूद संपादित करा)</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <form action="{{ route('budget-provision.update', $budgetProvision->id) }}" method="post">
                    ...
                    <div class="card">
                        <div class="card-header border-bottom pb-2 bg-primary">
                            <h5 class="text-white item-center mb-2">Edit Budget Provision (बजेट तरतूद संपादित करा)</h5>
                        </div>
