            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header border-bottom bg-primary pt-3 pb-1">
                        <div class="row">
                            <div class="col-6">
                                <h5 class="text-white mt-1">वृत्तपत्र मुद्रण प्रकार यादी</h5>
                            </div>
                            <div class="col-6 text-end">
                                <a href="{{ route('print-type.create') }}"><button class="btn btn-square btn-warning-gradien" type="button">वृत्तपत्र मुद्रण प्रकार जोडा <i class="fa fa-plus" aria-hidden="true"></i>
                                </button></a>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul class="action">
                                                <li class="edit">
                                                    <a href="{{ route('print-type.edit', $printType->id) }}"><button class="btn btn-square btn-primary" type="button">सुधारणे &nbsp;<i class="fa fa-pencil text-white" aria-hidden="true"></i>
                                                    </button></a>
                                                </li>
                                                <li class="delete">
