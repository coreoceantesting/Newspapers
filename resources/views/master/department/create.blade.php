            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('department.index') }}"> Newspaper Department List (वृत्तपत्र विभागाची यादी) </a></li>
                        <li class="breadcrumb-item active">Add Newspaper Department (वृत्तपत्र विभाग जोडा)</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <form action="{{ route('department.store') }}" method="post">
                    ...
                    <div class="card">
                        <div class="card-header border-bottom pb-2 bg-primary">
                            <h5 class="text-white item-center mb-2">Add Newspaper Department (वृत्तपत्र विभाग जोडा)</h5>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row g-3 pb-3">
                                ...
                                <div class="col-md-6 col-lg-6 col-12">
                                    <label class="form-label" for="initial">Initial (आरंभिक) <span class="error">*</span></label>
