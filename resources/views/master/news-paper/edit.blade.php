            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">वृत्तपत्र संपादित करा</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <form action="{{ route('news-paper.update', $newsPaper->id) }}" method="post">
                    ...
                    <div class="card">
                        <div class="card-header border-bottom pb-2 bg-primary">
                            <h5 class="text-white item-center mb-2">वृत्तपत्र संपादित करा</h5>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row g-3 pb-3">
                                ...
                                <div class="col-md-6 col-lg-6 col-12">
                                    ...
                                    <input @if ($errors->has('name')) class="form-control is-invalid" @else style="border: 1px solid #475ecc6b;"  @endif class="form-control"  name="name" id="name" type="text" placeholder="नाव" value="{{ $newsPaper->name }}" required>
                                    @error('name')
                                        <span class="error">{{ $message }}</span>
                                    @enderror
                                </div>
