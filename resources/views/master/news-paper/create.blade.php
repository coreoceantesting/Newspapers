            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add Newspaper (वर्तमानपत्र जोडा)</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <form action="{{ route('news-paper.store') }}" method="post">
                    ...
                    <div class="card">
                        <div class="card-header border-bottom pb-2 bg-primary">
                            <h5 class="text-white item-center mb-2">Add Newspaper (वर्तमानपत्र जोडा)</h5>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row g-3 pb-3">
                                ...
                                <div class="col-md-6 col-lg-6 col-12">
                                    <label class="form-label" for="name">Newspaper Name (वर्तमानपत्राचे नाव) <span class="error">*</span> (For New Line use "&lt;br&gt;")</label>
