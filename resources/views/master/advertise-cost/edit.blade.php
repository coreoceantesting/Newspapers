<x-layout>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <form action="{{ route('advertise-cost.update', $advertiseCost->id) }}" method="post">
                    @csrf
                    @method('put')
                        ...
                        <div class="card-body">
                            <div class="row g-3 pb-3">
                                ...
                                <div class="col-md-6 col-lg-6 col-12">
                                    ...
                                    <input @if ($errors->has('no_of_newspaper')) class="form-control is-invalid" @else style="border: 1px solid #475ecc6b;"  @endif class="form-control"  name="no_of_newspaper" id="no_of_newspaper" type="number" placeholder="वृत्तपत्रांची संख्या" value="{{ $advertiseCost->no_of_newspaper }}">
